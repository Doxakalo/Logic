...
- Vše je směřováno na `index.php` a rozepsáno v /app/pages/informations.php **Informations:** [http://localhost/logic/index.php](http://localhost/logic/index.php?p=informations)
